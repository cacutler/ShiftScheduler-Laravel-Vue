    ...
    <div class="flex flex-col space-y-6">
        ...
        <Form v-bind="ProfileController.update.form()" class="space-y-6" v-slot="{ errors, processing }">
            ...
            <div class="grid gap-2">
                ...
                <Input id="username" type="text" class="mt-1 block w-full" :default-value="user.username" autocomplete="username" placeholder="Username"/>
                <InputError :message="errors.username"/>
            </div>
            <div class="grid gap-2">
                <Label for="email">Email address</Label>
                <Input id="email" type="email" class="mt-1 block w-full" name="email" :default-value="user.email" autocomplete="email" placeholder="Email address"/>
            ...
            <div class="grid gap-2">
                ...
                <Input id="phone_number" type="tel" name="phone_number" :default-value="user.phone_number ?? undefined" autocomplete="tel" placeholder="+1 (555) 000-0000"/>
